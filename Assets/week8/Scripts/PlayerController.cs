...
public class PlayerController : MonoBehaviour, Damagable//, Slappable
{
	...
	public void Damage(Damage damage)
	{
		...
		{
			weapons.weapons[weapons.currentWeapon].DamageReaction();
	...
	public void Die(Vector3 dir)
	{
		...
		//Game.timeManager.SlowMotion(0.1f, 1f, 0.2f);
	...
	private void Update()
	{
		...
		if (damageTimer != 0f)
		{
			...
			cg.mixerGreenOutRedIn.value = Mathf.Lerp(0, -150, damageTimer/3);
		}
	}
