Shader "LGame/Effect/UI"
{
    ...
    SubShader
    {
        ...
        Blend [_SrcBlend] [_DstBlend],[_SrcAlphaFactor][_DstAlphaFactor]
        ZWrite [_ZWriteMode]
        ZTest [_ZTestMode]
        Cull [_CullMode]
        ...
        Pass
        {
			...
			#include "Assets/CGInclude/LGameUIEffect.cginc" 
	...
	CustomEditor"LGameSDK.AnimTool.LGameEffectUIShaderGUI"
}
