Shader "LGame/Effect/ModelDefault_Outline"
{																		
	Properties
	{
		...
		_FlowlightMultipliers("Emission Multipliers", Float) = 0 //自发光强度
	...
	SubShader
	{
		Tags { "RenderType"="AlphaTest" "LightMode"="ForwardBase" "Queue"="AlphaTest" }
		LOD 75
		...
		//Outline Pass
		UsePass "Hidden/Character/Outline/BASE"
	}
	//Base 	
	SubShader
	{
