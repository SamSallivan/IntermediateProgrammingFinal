Shader "LGame/StarActor/ClearCoat"
{
	Properties
	{
		...
		_ClearCoatRoughness("Clear Coat Roughness",Range(0.0,1.0)) = 0.0
	...
	CustomEditor "LGameSDK.AnimTool.LGameStarActorClearCoatShaderGUI"
}
