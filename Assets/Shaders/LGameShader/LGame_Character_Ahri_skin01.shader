...
Shader "LGame/Character/Ahri_skin01"
{
	Properties
	{
...
#pragma exclude_renderers gles
	...
	fixed4 frag (v2f i) : SV_Target
	{
		...
		// 部分低端机mask有溢出情况
		fixed combinMask = clamp(mask.r + mask.g + mask.b + mask.a, 0.0, 1.0);
		fixed4 col = lerp(lerp(effectCol, _RimLightColor, i.color), mainTex, combinMask);
