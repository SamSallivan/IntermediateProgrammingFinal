...
Shader "LGame/Character/NPC_GpuSkinned_Transparent"
{
	Properties
	{
...
//		float4 pos = mul(mat0, v.vertex) * v.uv2.y + mul(mat1, v.vertex) * v.uv2.w;
	...
	SubShader
	{
		...
		//default pass
		UsePass "LGame/Character/Shadow_GpuSkinned/Shadow"
		Pass
		{
			Name "NPCGpuSkinned"
			Lighting Off
		...
		UsePass "Hidden/Character/GpuSkinnedOutline/GpuSkinOutlineBase"
		
		//srp pass
		UsePass "LGame/Character/Shadow_GpuSkinned Srp/CharacterShadowSrp"
		UsePass "LGame/Character/Shadow_GpuSkinned Srp/Shadow"
		UsePass "Hidden/LGame/Character/NPC_GpuSkinned_Transparent Srp/NPCGpuSkinnedTransParentDefault"
		UsePass "Hidden/Character/GpuSkinnedOutline Srp/GpuSkinOutlineBase"
 ...
 //       
	...
	//	//srp pass
	//	UsePass "Hidden/LGame/Character/NPC_GpuSkinned_Transparent Srp/NPCGpuSkinnedTransParentDefault"
	//	UsePass "LGame/Character/Shadow_GpuSkinned Srp/SoftShadow"
	//	UsePass "Hidden/Character/GpuSkinnedOutline Srp/GpuSkinOutlineBase"
