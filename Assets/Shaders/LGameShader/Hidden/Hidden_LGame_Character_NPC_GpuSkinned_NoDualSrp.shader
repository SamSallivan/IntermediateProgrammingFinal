...
Shader "Hidden/LGame/Character/NPC_GpuSkinned_NoDual Srp"
{
	Properties
	{
...
#define _FxSpeed_arr effect
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "LightMode" = "NPCGpuSkinnedNoDualDefault" "Queue"="AlphaTest" }

		//基础Pass
		Pass
		{
			Name "NPCGpuSkinnedNoDualDefault"
			Tags{"LightMode" = "NPCGpuSkinnedNoDualDefault"}
			Lighting Off
			Fog { Mode Off }
			CGPROGRAM
			#pragma vertex vert
