...
Shader "Hidden/LGame/Character/NPC_GpuSkinned_Transparent_Nodual Srp"
{
	Properties
	{
...
#define _AlphaCtrl_arr character
	...
	SubShader
	{
		Tags { "RenderType"="Transparent" "LightMode"="NPCGpuSkinnedTransParentNoDualDefault" "Queue"="Transparent" }
		Blend SrcAlpha OneMinusSrcAlpha

		//基础Pass
		Pass
		{
			Name "NPCGpuSkinnedTransParentNoDualDefault"
