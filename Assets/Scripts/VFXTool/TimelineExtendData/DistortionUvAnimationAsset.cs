...
{
    [System.Serializable]
    public class DistortionUvAnimationAsset : PlayableAsset
    {
        // 原始功能为：直接使用曲线变换
        ...
        public float speedTilingX = 0;
        public float speedTilingY = 0;
        ...
        public AnimationCurve speedCurveZ = default;
        public AnimationCurve speedCurveW = default;

        public ExposedReference<Renderer> rendererDataBind;

        public override Playable CreatePlayable(PlayableGraph graph, GameObject owner)
        {
            var playable = ScriptPlayable<DistortionUvAnimationBehaviour>.Create(graph);
            DistortionUvAnimationBehaviour behaviour = playable.GetBehaviour();
